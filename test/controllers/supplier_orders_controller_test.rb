...
class SupplierOrdersControllerTest < ActionController::TestCase
  ...
  test "should create supplier_order" do
    assert_difference('SupplierOrder.count') do
      post :create, supplier_order: { branch_id: @supplier_order.branch_id, date: @supplier_order.date, date_fn: @supplier_order.date_fn, date_st: @supplier_order.date_st, number: @supplier_order.number, suppliers_id: @supplier_order.suppliers_id }
    end
  ...
  test "should update supplier_order" do
    patch :update, id: @supplier_order, supplier_order: { branch_id: @supplier_order.branch_id, date: @supplier_order.date, date_fn: @supplier_order.date_fn, date_st: @supplier_order.date_st, number: @supplier_order.number, suppliers_id: @supplier_order.suppliers_id }
    assert_redirected_to supplier_order_path(assigns(:supplier_order))
  end
